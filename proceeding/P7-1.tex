...
\ECM{What typical localization do we get once the GW and ACS/Ibis veto skymaps are
intersected?}
...
\begin{figure}[!ht]
	\centering
  	...
  	\caption{(\textit{Left}) Cumulative distribution of the fraction of the
          ...
          after the prompt emission. Dotted lines correspond to the model
          assuming realistic distribution of short GRB
          luminosities. \textcolor{blue}{Change figures}}
...
\ECM{What is the typical flux for a 3-sigma detection in IBIS/ISGRI?}

\ECM{What is the inclination distribution of the 40 \% binaries whose GW error
  box can be covered to 80 \% ?}

\ECM{I guess the light curve duration depends on the inclination -- Is this
  true? Do this have any implications on the repointing strategy?}
