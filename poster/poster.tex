...
\emph{We model the prompt emission spectrum by a broken power-law, so-called the Band
...
\begin{center}
    \includegraphics[height=9cm]{figures/spectra.png}
...
LIGO events (\vs{SNR})} and \emph{0.1 in 6 month in the case of loud events
(\vs{SNR})}.
...
region, and find that \emph{in \vs{1\%} of the cases 99.7\% of the localization can be
