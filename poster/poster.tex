...
\begin{center}\vspace{.5cm}
    ...
    \captionof{figure}{Prompt and afterglow emission spectra from SGRBs systems. Flux have been normalized with respect to INTEGRAL finite energy band $\left[ 75 \, , 2000 \right] \, \mathrm{keV}$.}
    \label{spectra}
\end{center}
