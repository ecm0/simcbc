...
position of the source using the BAYESTAR pipeline \cite{PhysRevD.93.024013}.
With two detectors only, the position uncertainty is large and contained in a
window of 700--2000 square degrees.
