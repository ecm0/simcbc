...
\begin{center}\vspace{.5cm}
    ...
    \captionof{figure}{\vs{units are incompatible with a realistic model. also specify the model} Prompt and afterglow emission spectra from SGRBs systems. Flux have been normalized \vs{normalized to what?} with respect to INTEGRAL/SPI-ACS finite energy band $\left[ 75 \, , 2000 \right] \, \mathrm{keV}$. }
    \label{spectra}
\end{center}
